$(".filter").change(function () {
    ...
    $("#result .col.mb-4").filter(function () {
        $(this).toggle(
            $(this).find(".Category1").val().indexOf(cat1) > -1 &&
                $(this).find(".Category2").val().indexOf(cat2) > -1 &&
                $(this).find(".Category3").val().indexOf(cat3) > -1 &&
                $(this).find(".Category4").val().indexOf(cat4) > -1 &&
                $(this).find(".book").val().indexOf(book_audio) > -1 &&
                $(this).find(".digital").val().indexOf(dig_phy) > -1
        );
    });
});
col;
