...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="row col-12 col-sm-8">
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" class="btn btn-orange mb-2" data-toggle="modal"
                                data-target="#addNewSemBranch"><i class="fa fa-plus" aria-hidden="true"></i></button>
                        </div>
    ...
    <!-- Modal for books -->
    <div class="modal fade" id="modelForBooks" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
                                ...
                                <div class="col mb-4">
                                    <div class="card">
                                        <img class="card-img-top"
                                            src="./assets/node_modules/shards-ui/dist/images/demo/stock-photos/1.jpg"
                                            alt="Card image cap" />
    ...
    <div class="modal fade" id="addNewSemBranch" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog" style="
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" min="1" class="form-control" id="semesterModal"
                                    placeholder="Add a new Semester">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-orange" onclick="addSemBranch()"
