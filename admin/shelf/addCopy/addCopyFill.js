        ...
        success: function (data) {
            ...
            html +=
                ...
                <div class="modal-body">
                  <div class="row row-cols-1 row-cols-md-4" id='displayBookCopies' style="height: 65vh; overflow-y: scroll;">`;
            if (data) {
          ...
          <div class="row text-center">
                    ...
                    if (item.shelfID == shelfID)
                        html +=
                            `
                            <button type="submit" class="btn btn-blue" onclick="removeCopy('` +
                            item.copyID +
                            `','` +
                            i +
                            `')">
                        ...
                        html +=
                            `             <button type="submit" class="btn btn-orange" onclick="addCopy('` +
                            item.copyID +
                            `','` +
                            i +
                            `')">`;
