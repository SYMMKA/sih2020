...
function loadCategory() {
  ...
  for (var mainCategory = 0; mainCategory < test.length; mainCategory++) {
    ...
    ] = new Option(test[mainCategory].description, mainCategory);
  }
  ...
  mainCategorySelect1.onchange = function () {
    ...
    if (!test[this.value].subordinates) {
  ...
  mainCategorySelect2.onchange = function () {
    ...
    if (
      !test[mainCategorySelect1.value].subordinates[this.value].subordinates
    ) {
      // hides sub category if not available
  ...
  mainCategorySelect3.onchange = function () {
    ...
    if (
      !test[mainCategorySelect1.value].subordinates[mainCategorySelect2.value]
...
function c1() {
  for (
    var mainCategory = 0;
    mainCategory < test[mainCategorySelect1.value].subordinates.length;
    mainCategory++
  ) {
    var description =
      test[mainCategorySelect1.value].subordinates[mainCategory].description;

    var number =
      test[mainCategorySelect1.value].subordinates[mainCategory].number;
