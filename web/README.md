...
_Records and history of the copies you delete will still remain. You will still be able to generate a report of the actions made on the book/copy whenever required. _
...
Click on ![alt_text](images/image3.png "image_tooltip") in the NavBar on the top right of your screen to open the settings page. Here you can easily customize AlphaByte according to your library needs.
...
_Ss of general settings here._  
...
#### Report through a specific time period _(Feature not added yet)_
...
A PDF of this RECEIPT can be downloaded and can be accessed in the Downloads Section of your PC.
   ...
   _Ss of billing track example._
   ![alt_text](images/image7.png "image_tooltip")
