    ...
    $.ajax({
        ...
        success: function (data) {
            if (data) {
				...
				<div class="d-flex justify-content-between btn-blue pt-4 pl-4 pr-4 pb-2 rounded">
				<h2 class="branch font-weight-bold text-white">` +
                        branch +
                        `<h2>
        <button class="btn btn-orange" onclick="deleteBranch('` +
                        branch +
                    ...
                    for (sem in data[branch]) {
                        html +=
                            `<div class="card sem-card show-books"
							>
                            <div
		...
		<div class="col-md-8 col-lg-10">
            ...
            html +=
                `
									...
									<button type="button" class="btn btn-orange btn-block mb-5" onclick="deleteFromSection(` +
                id +
                `, '` +
                branch +
                `', ` +
