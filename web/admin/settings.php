                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                            <form>
                                ...
                                <!-- FINE -->
                                <div class="form-group row">
                                    <label for="lightDamageSt" class="col-sm-4 col-form-label">Light Damage Fine %</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="0" id="lightDamageSt" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="mediumDamageSt" class="col-sm-4 col-form-label">Medium Damage Fine %</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="0" id="mediumDamageSt" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="heavyDamageSt" class="col-sm-4 col-form-label">Heavy Damage Fine %</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="0" id="heavyDamageSt" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lostSt" class="col-sm-4 col-form-label">Lost Book Fine %</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="0" id="lostSt" />
                                    </div>
                                </div>
                                <!-- FINE -->
                                <h5 class="font-weight-bold mb-4 bg-light p-2 rounded">
                                ...
                                <!-- FINE -->
                                <div class="form-group row">
                                    <label for="lightDamageTr" class="col-sm-4 col-form-label">Light Damage Fine %</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="0" id="lightDamageTr" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="mediumDamageTr" class="col-sm-4 col-form-label">Medium Damage Fine %</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="0" id="mediumDamageTr" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="heavyDamageTr" class="col-sm-4 col-form-label">Heavy Damage Fine %</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="0" id="heavyDamageTr" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lostTr" class="col-sm-4 col-form-label">Lost Book Fine %</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="number" min="0" id="lostTr" />
                                    </div>
                                </div>
                                <!-- FINE -->
                                <h5 class="font-weight-bold mb-4 bg-light p-2 rounded">
