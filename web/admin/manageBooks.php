...
<body>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-2 mb-2">
                                <div class="row no-gutters justify-content-center text-center h-100 align-items-stretch">
                                    <div class="col-12">
                                        <h4 class="text-white">Issued: <h1 class="text-white" id="issued"></h1>
                                        </h4>
                                    </div>
                                    <div class="col-12">
                                        <h4 class="text-white">Reserved: <h1 class="text-white" id="reserved"></h1>
                                        </h4>
                                    </div>
                                    <div class="col-12">
                                        <h4 class="text-white">Available: <h1 class="text-white" id="available"></h1>
                                        </h4>
                                    </div>
                                    <div class="col-12">
    ...
    <script src="manageBooks/navigation.js"></script>
