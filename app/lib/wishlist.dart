  ...
  void removeBook(String stud_ID, String bookID) async {
    ...
    try {
      var response = await http.post(
          Uri.encodeFull(
              rootUrl + "wishlistItems.php"),body: {
        "stud_ID":stud_ID,
        "operation": "delete",
        "bookID": bookID,
      },
          ...
          child: ListView.builder(
            // gridDelegate:SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 1),
              ...
              itemBuilder: (BuildContext context, int x) {
                return gridViewItem(
                    shelfs[x]["title"],shelfs[x]["bookID"], shelfs[x]["author"],shelfs[x]["publisher"],shelfs[x]["status"]);
              }),
        ));
  }

  Widget gridViewItem(
      String title, String BookId, String author, String publisher, String status) {
    return Container(
        ...
        child: Card(
            ...
            child: Container(
              ...
              //width: 100,
              //height: 120,
              color: status=="1"?Color(0xff4AD7D1).withOpacity(0.3):Colors.grey[200],
              child: Column(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(title,  overflow: TextOverflow.clip,
                              maxLines: 1,
                              softWrap: false,),
                            Text("Book ID:" + BookId, overflow: TextOverflow.ellipsis,
                              maxLines: 1,),
                            Text("Author:" + author, overflow: TextOverflow.ellipsis,
                              maxLines: 1,),
                            Text("Publisher:" + publisher, overflow: TextOverflow.ellipsis,
                              maxLines: 1,),
                          ],
                        ),
                      ),
